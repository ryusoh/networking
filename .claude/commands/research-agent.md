...
$ARGUMENTS — the query or topic to investigate.
...
```bash
python3 tools/research/scene_builder.py "$ARGUMENTS" --max-tokens 8192
```
...
```bash
python3 tools/research/citation_engine.py "$ARGUMENTS"
```
