...
v Internet-standard management
SM
...
What is network
management?
v autonomous systems (aka “network”): 1000s of
...
Network Management
9-22
Presentation problem: potential
solutions

1. Sender learns receiver’s format. Sender
translates into receiver’s format. Sender
sends.
– real-world
2. Send
er’s
format. Receiver translate into receiver-
local format
– real-world-analogy
– pros and cons?
...
transmitted
§ each transmitted object has Type, Length,
Value (TLV) encoding
