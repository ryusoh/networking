...
if __name__ == "__main__":
	...
	for config in processor_configs:
		...
		for i in range(trials):
			num_cycles, w = simulate(file,workloads, _is_fully_balanced, test_balance, config, trials) ## Calculate number of cycles it took to load balance in this simulation
