...
Due 25-January-2019, in pdf format on CANVAS .
P0
LM
M0
P1
...
Processing elementt
Memory module
distributed system deems user as single coherent system
...
• Use 3 equal size arrays to represent the processing elements’ requested memory module,
the wait counters for each of them, and the priority of connection.
