...
def create_graph(dataset,outfile,title):
	...
	legend_colors = ['lightgray','silver','darkgray','gray','dimgray','black']
	...
	ax.legend(legend_data,legend_keys,loc='upper right', ncol=6, title="Number of Processors", fontsize='small', fancybox=True)
...
if __name__ == "__main__":
	...
	create_graph(processor_data_uniform,'plots/uniform.png','Uniform Distribution')
	create_graph(processor_data_gaussian,'plots/gaussian.png','Gaussian Distribution')
