...
static GF_Err gf_mpd_parse_adaptation_set(GF_MPD *mpd, GF_List *container, GF_XMLNode *root)
{
	...
	// - task 1: GPAC parses information in adaptation set columns here in this function. To parse "model", 
	//   you will have to add something.
	// - task 1 HINT: See how its counterparts - other columns int adaptation set such as bitstreamSwitching, 
	//   lang, maxFrameRate, etc., - are parsed.
