...
#if defined(XP_WIN) && !defined(__SYMBIAN32__)
/*JLF - include windows.h for MSVC6+PlatformSDK compatibility*/
#include <windows.h>
#include <windef.h>
#include <winbase.h>
#endif

#if defined(XP_UNIX) || defined(XP_BEOS) || defined(__SYMBIAN32__)
