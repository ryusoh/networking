...
cd openHEVC
"%GIT%" checkout merge_shm-dev_to_hevc-rext
cd ..
goto copy_openhevc
...
if not exist ..\gpac_public\extra_lib\lib mkdir ..\gpac_public\extra_lib\lib
if not exist ..\gpac_public\extra_lib\lib\win32 mkdir ..\gpac_public\extra_lib\lib\win32
if not exist ..\gpac_public\extra_lib\lib\x64 mkdir ..\gpac_public\extra_lib\lib\x64
