                            ...
                            program_config *pce)
{
	...
	// FIXME: when compile for Android with arch ARM, need compare sbr_present_flag with 0xFF rather than -1 ???
    if ((mp4ASC->sbr_present_flag == -1) || (mp4ASC->sbr_present_flag == 0xFF))
    {
