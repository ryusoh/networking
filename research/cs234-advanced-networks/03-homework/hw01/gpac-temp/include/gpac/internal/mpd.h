...
typedef struct
{
	...
	// - task 1: This is the structure GPAC stores adaptation set columns! You should always keep in mind 
	//   that "model" is the additional column you parse. Therefore, where should we store this parsed value?
	// - task 1 HINT: How other columns in adaptation set are stored in this structure?
